...
fun interface SyntaxTreeToDeterministicFinateAutomata : (ISyntaxTree) -> DeterministicFiniteAutomata<String, String>


object SyntaxTreeToDfa : SyntaxTreeToDeterministicFinateAutomata {
    ...
    override fun invoke(tree: ISyntaxTree): DeterministicFiniteAutomata<String, String> {
        val charPos = tree.root.mapNotNull {
            when(it.data) {
                is Character -> it.data.char to it.position!!
