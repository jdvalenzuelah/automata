...
class AutomataApp(
    ...
    private data class RegexTest(var regex: String, var testString: String)
        ...
        render(regex) {
            if(regex.value.isNotEmpty()) {
                div(fomantic.ui.vertical.segment) {
                    ...
                    val scope = regexHandler.getAutomataScopeFromRegex(regex.value)
                    ...
                    div(fomantic.ui.segment) {
                        ...
                        renderAutomata("NFA:", scope.nfa.toFileFormat(), scope.nfaGraphBase64) {
                            render(testString) {
                                ...
                                renderSimulationResult(testString.value, regexHandler.getSimulationNFA(testValue, scope.nfa))
                            }
                        }
